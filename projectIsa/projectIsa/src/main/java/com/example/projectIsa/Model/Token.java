...
public class Token {
	...
	public static String getAudienceUnknown() {
		return AUDIENCE_UNKNOWN;
	}

	public static String getAudienceWeb() {
		return AUDIENCE_WEB;
	}

	public static String getAudienceMobile() {
		return AUDIENCE_MOBILE;
	}

	public static String getAudienceTablet() {
    ...
    public String generateToken(RegisteredUser user) {
        return Jwts.builder()
            ...
            //    .claim("agent",user.isAgent())
                .claim("id", user.getId())
                .claim("username", user.getEmail())//moguce je postavljanje proizvoljnih podataka u telo JWT tokena
